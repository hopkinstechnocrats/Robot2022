...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    public static final double kWheelHeight = .1;
    public static final double kMaxSpeedMetersPerSecond = 4;

    public static final double kFrontRightOffset = 0.15339807878856412 + Math.PI; //Actually BackLeft
    public static final double kFrontLeftOffset = 0.796136928912 + 0.034 + Math.PI; //Actually BackRight
    public static final double kRearRightOffset = 1.6520973085528357 + 0.4678641403051204 + Math.PI; //Actually FrontLeft
    public static final double kRearLeftOffset = -0.07516505860639658 + Math.PI; //Actually FrontRight
  }
