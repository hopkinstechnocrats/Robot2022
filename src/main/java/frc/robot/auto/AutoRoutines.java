...
public class AutoRoutines {
    ...
    public SwerveControllerCommand DriveBetweenPoints(Translation2d startingPosition, Translation2d midPosition,
        ...
        Trajectory exampleTrajectory = TrajectoryGenerator.generateTrajectory(
                ...
                new Pose2d(endingPosition, new Rotation2d(0)),
                config);
    ...
    public SequentialCommandGroup TwoBallAutoRoutine(Pose2d zeroPose) {
        return new SequentialCommandGroup(
                ...
                new RunCommand(() -> this.DriveBetweenPoints(zeroPose.getTranslation(),
                 FieldPositions.R3, FieldPositions.R3, m_robotDrive), m_robotDrive).withTimeout(0.5),
                 //turn on launcher have enough time to speed up 
            
                 new RunCommand(() -> m_launcher.spinFromDistance(Constants.LauncherConstants.heightOfHighHubReflectors/(Math.tan(m_limelight.getVerticalAngle()))), m_launcher),
                // aim the robot towards the hub
               new RunCommand(() -> {
                    m_robotDrive.drive(0, 0, -1*m_limelight.getRotationSpeed()); 
                    
                  }, m_robotDrive).withTimeout(2.0),//this time is too long...maybe 
                ...
                new InstantCommand(m_intake::intakeOut), //actually back in lmao
